class VaccinationCentersByDistrictIdModel {
  Data data;
  int status;

  VaccinationCentersByDistrictIdModel({this.data, this.status});

  VaccinationCentersByDistrictIdModel.fromJson(Map<String, dynamic> json) {
